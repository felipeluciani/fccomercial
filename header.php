...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <div id="container" class="aligncenter clearfix">
            <header role="banner" class="clearfix">
                <h1 class="logo alignleft"><a href="<?php echo get_option('home'); ?>/"><img src="<?php print IMAGES; ?>/logo.png" alt="<?php bloginfo('name'); ?>" /></a></h1>
        <!--      <p class="description"><?php bloginfo('description'); ?></p> -->
                <div class="ad-hearder alignleft"></div>
            </header>
            <div id="navigation">
